...
<body>
        ...
        <div class='panel-body'>        
        	...
        	<div id="import-data-panel-container">   
            	...
            	<select id="communications-type-select">
	                <option id="telecommunication">Import Telecommunications</option>
                	<option id="people">Import Owners/Users Data</option>
                </select>         	
    ...
    <div id="import-statistics-panel">
        ...
        <table cellpadding="5">
            ...
            <tr>
                <td>Number of processed people:</td>
                <td id="import-proc-people-cell"></td>
            </tr>
            <tr>
                <td>Number of inserted people:</td>
                <td id="import-ins-people-cell"></td>
            </tr>
            <tr>
                <td>Number of dublicate people:</td>
                <td id="import-dub-people-cell"></td>
            </tr>
            <tr>
                <td colspan="2">&nbsp;</td>
            </tr>
            <tr>
                <td>Number of processed associations:</td>
                <td id="import-proc-assocs-cell"></td>
            </tr>
            <tr>
                <td>Number of inserted associations:</td>
                <td id="import-ins-assocs-cell"></td>
            </tr>
            <tr>
                <td>Number of dublicate associations:</td>
                <td id="import-dub-assocs-cell"></td>
            </tr>
        </table>
    ...
    <script type="text/javascript" src="templates/javascript/uploads.js"></script>
